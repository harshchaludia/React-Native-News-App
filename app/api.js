...
export async function getHeadlines(country = "us"){
    try{
        ...
        let [finance, advertisement, general, fitness, science, sports, industrialscience] = response;

        return {finance, advertisement, general, fitness, science, sports, industrialscience};
