...
const DefaultView = ({title, data, renderItem}) => {
    return (
        <ScrollView horizontal={true} showsHorizontalScrollIndicator={false} style={{backgroundColor:'black'}}>
            {data.map((item, index) => {
                return (
...
const styles = StyleSheet.create({
    ...
    multiCol:{flex: 1, flexDirection: 'column', paddingTop: 8, paddingBottom: 8},
